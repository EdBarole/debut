                        ...
                        <div class="panel panel-card recent-activites">
                            ...
                            <div class="panel-body">
                                <form action="{{ action('BrandsController@store') }}" method="post" class="form-horizontal group-border stripped">
                                    ...
                                    <div class="form-group form-group-lg">
                                        <label class="col-lg-2 col-md-3 control-label">Price</label>
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="price" data-masked="" data-inputmask="'mask': '999'" placeholder="Price" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group form-group-lg">
                                        <label class="col-lg-2 col-md-3 control-label">Amount invested</label>
                                        <div class="col-lg-10 col-md-9">
                                            <input type="text" name="amount_invested" data-masked="" data-inputmask="'mask': '999'" placeholder="Amount invested" class="form-control">
                                        </div>
                                    </div>
                                    <!-- End .form-group  -->
